...
<html>
	...
	<body>
		...
		<h1>You found Stella Crinita!</h1>
		<div class="spell">
			<img class="spellimg" src="assets/spell3.svg" />
		</div>
		<form class="learn" action="record-spell3.php" method="POST">
			<div class="row1">
				<input type="hidden" name="spell1" value="1" />
				<input type="image" class="spellButton" id="submit" alt="submit" src="assets/learnspellbutton.svg">
			</div>
		</form>
